...
export default function SymphonyPage() {
    ...
    const ProjectNote = () => {
        return (
        <div className="bg-blue-900/20 border border-blue-700/30 rounded-xl p-6 mb-16">
            <h2 className="text-lg font-semibold text-blue-300 mb-2">Note</h2>
            <div className="prose prose-invert">
            <p className="text-gray-300">
                On November 2024, Spotify discontinued support for the audio features and analysis, making new users unable to sign up for the application when being run. Fortunately, during the development and testing phase of this application, I was able to create test users which are able to be used for demo purposes. I am currently exploring alternative options.{' '}
                <a 
