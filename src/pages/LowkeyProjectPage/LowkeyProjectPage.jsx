        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              ...
              <a href="https://github.com/benjaehyun/lowKEY" target="_blank" className='underline'>Link To GitHub</a> || &nbsp;
              <a href="https://lowkey-08ba0f67b0aa.herokuapp.com/" target="_blank" className='underline'>Link To App</a>
              <p className='mt-6 text-sm leading-8 text-gray-700'> Note: In order to demo the app, please contact me. Due to the nature of Spotify's Developer API, I need to manually whitelist your Spotify Account in my app's permissions</p>
          ...
          <div className="lg:pr-4">
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              <p>
                ...
                profiles displayed to the user will be sorted based on that similarity score. Once users are matched (they both send a "like" to each other), they can communicate via private messages
              ...
              <p className="mt-8">
                Notes: 
                The most difficult part of starting this app was implementing Spotify's Authorization Flow with PKCE in addition to using JWT's to manage user data separate from Spotify. There was a particular issue
                where the API calls needed a redirect flow in the authentication process. The redirect needed to go to a page that needed to make another API call which involved particular key's in the redirect URI, which didn't work well 
                with React component rendering. Once that was setup, the next difficulty was also the most exciting: the algorithm for similarity metrics across users' songs. After extensive research, I ended up sorting the various song features 
                ...
                values are all within a given range. Aside from the actual algorithm design, another challenge was normalizing the values so that no single metric would have an overwhelming impact on the similarity score. Things like instrumentalness 
